		...
		<div class="settingcolumnwrap">
			...
			<div id="accordion_advance" class="package_advance">
				...
				<div class="advance-input">
					...
					<input type="number" name="max_column" class="medium" id="max_column" value="" placeholder="e.g. 6" />
					...
					<input type="text" name="container_width" class="medium" id="container_width" value="" placeholder="e.g. 99%" />
